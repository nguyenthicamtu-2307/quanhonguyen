...
public class TinyDB {
    ...
    public void putListObject(String key, ArrayList<Mon> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(Mon player: playerList){
            objStrings.add(gson.toJson(player));
        }
        putListString(key, objStrings);
    }
    public ArrayList<Mon> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<Mon> playerList =  new ArrayList<Mon>();

        for(String jObjString : objStrings){
            Mon player  = gson.fromJson(jObjString,  Mon.class);
