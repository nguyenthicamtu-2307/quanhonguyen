...
public class Doiquaadapter extends ArrayAdapter<Mon> {
     ...
     */
    public Doiquaadapter(@NonNull Context context, int resource, @NonNull List<Mon> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        @SuppressLint("ViewHolder") View rowview=inflater.inflate(R.layout.rowdoiqua,parent,false);
